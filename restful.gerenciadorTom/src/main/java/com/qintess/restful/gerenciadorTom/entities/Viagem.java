package com.qintess.restful.gerenciadorTom.entities;
...
public class Viagem implements Serializable {
	...
	private static final long serialVersionUID = 3336963278521618216L;
	...
	public String toString() {
		return "Viagens [id=" + id + ", localDeDestino=" + localDeDestino + ", dataPartida=" + dataPartida
