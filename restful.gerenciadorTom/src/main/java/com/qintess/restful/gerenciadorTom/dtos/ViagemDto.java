package com.qintess.restful.gerenciadorTom.dtos;
...
public class ViagemDto implements Serializable {
	...
	private static final long serialVersionUID = -5916268275211964138L;
	...
	public ViagemDto(Long id, String localDeDestino, Date dataPartida, Date dataRetorno, String acompanhante) {
		this.id = id;
